    ...
    <>
      {task ? (
        <form
          ...
          className="w-full max-w-screen-lg h-fit z-10 bg-opacity-0 mx-auto"
        >
            ...
            <div className="w-56 flex flex-col gap-1">
              ...
              <div className="w-full max-w-56 flex items-start h-fit p-1 px-2 gap-2 bg-purple-600 rounded-md">
                <input
                  ...
                  name="start"
                  onChange={handleChange}
                  className="bg-transparent text-seasalt"
                  value={
                    formData?.start
              ...
              <div className="w-full max-w-56 flex items-start h-fit p-1 px-2 gap-2 bg-purple-600 rounded-md">
                <input
                  ...
                  name="end"
                  onChange={handleChange}
                  className="w-full bg-transparent text-seasalt"
                  value={
                    formData?.end
              ...
              <button
                type="submit"
                className="bg-outer-space py-2 rounded-md mt-2"
              >
                save
              </button>
            </div>
